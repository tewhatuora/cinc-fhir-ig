...
CodeSystem: CorrelationIdCodeSystem
Id: correlation-id-code-system
Title: "Correlation Identifier Type CodeSystem"
Description: "Defines the types of correlation identifiers used in meta.tag for tracing and tracking."
* ^status = #active
* ^caseSensitive = true
* ^content = #complete
* #hub-correlation-id "Hub Correlation ID" "Correlation identifier generated by the Health NZ Hub."
* #provider-correlation-id "Provider Correlation ID" "Tracking or correlation identifier generated by a provider system."
