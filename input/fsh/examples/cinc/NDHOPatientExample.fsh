...
* extension[=].extension[=].valueCodeableConcept.coding.version = "1.0.0"
* extension[=].extension[=].valueCodeableConcept.coding = $ns-information-source-code#BREG "Birth Register"
...
* extension[=].extension[=].valueCodeableConcept.coding = $ns-nz-citizenship-status-code#no "No"
* extension[=].extension[=].valueCodeableConcept.text = "No"

* address[+].type = #postal
* address[=].line = "65 Albany Street"
