Instance: HealthCheckQuestionnaireResponse
InstanceOf: QuestionnaireResponse
Usage: #example
* basedOn = Reference(CarePlan/e9f3a140-6ed9-43e6-9dd0-7e9cdf3516f3)
* questionnaire = "https://build.fhir.org/ig/tewhatuora/cinc-fhir-ig/Questionnaire-Questionnaire-HealthCheckQuestionnaire"
* status = #completed
...
* item[0].linkId = "1"
* item[=].text = "Symptoms - Pay attention to early symptoms that might indicate early onset of COVID"
...
* meta.versionId = "1"
* meta.lastUpdated = "2022-08-29T20:40:53.958Z"