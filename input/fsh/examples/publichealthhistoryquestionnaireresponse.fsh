...
* item.item[=].answer.valueCoding = #111523 "Pfizer/BioNtech"
...
* item.item[=].text = "Vaccine given"
* item.item[=].answer.valueCoding = #111534 "Moderna"
...
* item.item[=].text = "Vaccine given"
* item.item[=].answer.valueCoding = #111539 "AstraZeneca / Covishield"
