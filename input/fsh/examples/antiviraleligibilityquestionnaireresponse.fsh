...
* item[0].linkId = "CurrentDateTime"
* item[=].text = "Date"
* item[=].answer.valueDateTime = "2023-03-20"
* item[+].linkId = "ReviewDateTime"
* item[=].text = "Date Review Performed"
* item[=].answer.valueDate = "2023-03-20"
...
* item[=].item[=].answer.valueString = "Get from HPI"
...
* item[=].item[=].item[=].answer.valueString = "Get from HPI"
