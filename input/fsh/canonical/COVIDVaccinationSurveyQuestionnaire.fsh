...
* item[=].item[=].answerOption[+].valueCoding = $sct#386661006 "Fever or high temperature"
...
* item[=].item[=].answerOption[+].valueCoding = $sct#274640006 "Chills, shivering or feeling cold"
