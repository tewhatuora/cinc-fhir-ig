...
Severity: #error
Expression: "(status = 'active' and extension.where(url = 'http://hl7.org/fhir/StructureDefinition/request-statusReason').valueCodeableConcept.coding.where(
                code = 'ServiceGiven' or 
                code = 'ReturningToProvider' or 
                code = 'ReferredToOutreach' ).exists()) or 
             (status = 'completed' and extension.where(url = 'http://hl7.org/fhir/StructureDefinition/request-statusReason').valueCodeableConcept.coding.where(
                code = 'ServiceGiven' or 
             ...
             (status = 'revoked' and extension.where(url = 'http://hl7.org/fhir/StructureDefinition/request-statusReason').valueCodeableConcept.coding.where(
                code = 'Deceased' or 
             ...
             (status = 'on-hold' and extension.where(url = 'http://hl7.org/fhir/StructureDefinition/request-statusReason').valueCodeableConcept.coding.where(
                code = 'OnHold').exists())"
