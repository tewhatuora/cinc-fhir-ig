...
* item[=].text = "Please tell us about how much difficulty your condition causes in different areas of your life, which may limit the things you can do.  Each question below includes examples to illustrate some of the things this area of life covers. It is okay if some of these examples don’t apply to you. Please just think about whatever this area of life means for you.  Please select the number that most represents how much your condition affects each area of your life."
