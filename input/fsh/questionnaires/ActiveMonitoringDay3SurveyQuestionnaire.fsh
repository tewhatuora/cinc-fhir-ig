...
* item[=].item[=].answerOption[0].valueCoding = #"COVID-19 and flu vaccines at the same time" "COVID-19 and flu vaccines at the same time"
* item[=].item[=].answerOption[+].valueCoding = #"Only flu vaccine" "Only flu vaccine"
* item[=].item[=].answerOption[+].valueCoding = #"Only COVID-19 vaccine" "Only COVID-19 vaccine"
* item[=].item[=].answerOption[+].valueCoding = #"Other vaccine" "Other vaccine"
* item[=].item[=].answerOption[+].valueCoding = #"Was not vaccinated or do not recall" "Was not vaccinated or do not recall"
...
* item[=].item[=].answerOption[+].valueCoding = #"Can't remember" "Can't remember"
...
* item[=].item[=].item[=].answerOption[0].valueCoding = #"Myself" "Myself"
* item[=].item[=].item[=].answerOption[+].valueCoding = #"My dependent/whānau member" "My dependent/whānau member"
...
* item[=].item[=].item[=].required = true
* item[=].item[=].item[=].answerOption[0].valueCoding = #"Community vaccination centre" "Community vaccination centre"
* item[=].item[=].item[=].answerOption[+].valueCoding = #"General practice" "General practice"
* item[=].item[=].item[=].answerOption[+].valueCoding = #"Pharmacy" "Pharmacy"
* item[=].item[=].item[=].answerOption[+].valueCoding = #"Mobile vaccination unit" "Mobile vaccination unit"
* item[=].item[=].item[=].answerOption[+].valueCoding = #"Hospital or emergency room" "Hospital or emergency room"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"Anaphylaxis" "Anaphylaxis"
* item[=].item[=].answerOption[+].valueCoding = #"Syncope (fainting)" "Syncope (fainting)"
* item[=].item[=].answerOption[+].valueCoding = #"Seizure/ convulsion" "Seizure/ convulsion"
* item[=].item[=].answerOption[+].valueCoding = #"I don't know/ unsure" "I don't know/ unsure"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"0-5 minutes" "0-5 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"6-10 minutes" "6-10 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"11-15 minutes" "11-15 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"16-20 minutes" "16-20 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"21+ minutes" "21+ minutes"
* item[=].item[=].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl"
* item[=].item[=].extension.valueCodeableConcept = $questionnaire-item-control#drop-down "Drop down"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"0-5 minutes" 
* item[=].item[=].answerOption[+].valueCoding = #"6-10 minutes" "6-10 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"11-15 minutes" "11-15 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"16-20 minutes" "16-20 minutes"
* item[=].item[=].answerOption[+].valueCoding = #"21+ minutes" "21+ minutes"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"Syncope (fainting)" "Syncope (fainting)"
* item[=].item[=].answerOption[+].valueCoding = #"Fever" "Fever"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"Minor" "Minor"
* item[=].item[=].answerOption[+].valueCoding = #"Mild" "Mild"
* item[=].item[=].answerOption[+].valueCoding = #"Moderate" "Moderate"
* item[=].item[=].answerOption[+].valueCoding = #"Serious" "Serious"
* item[=].item[=].answerOption[+].valueCoding = #"Severe" "Severe"
* item[=].item[=].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl"
* item[=].item[=].extension.valueCodeableConcept = $questionnaire-item-control#drop-down "Drop down"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"Same arm as vaccination" "Same arm as vaccination"
* item[=].item[=].answerOption[+].valueCoding = #"Opposite arm to vaccination" "Opposite arm to vaccination"
* item[=].item[=].answerOption[+].valueCoding = #"Other" "Other"
* item[=].item[=].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl"
* item[=].item[=].extension.valueCodeableConcept = $questionnaire-item-control#drop-down "Drop down"
...
* item[=].item[=].answerOption[+].valueCoding = #"3 or more days" "3 or more days"
* item[=].item[=].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl"
* item[=].item[=].extension.valueCodeableConcept = $questionnaire-item-control#drop-down "Drop down"
...
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueCoding = #"Very poor" "Very poor"
* item[=].item[=].answerOption[+].valueCoding = #"Poor" "Poor"
* item[=].item[=].answerOption[+].valueCoding = #"Average" "Average"
* item[=].item[=].answerOption[+].valueCoding = #"Good" "Good"
* item[=].item[=].answerOption[+].valueCoding = #"Excellent" "Excellent"
