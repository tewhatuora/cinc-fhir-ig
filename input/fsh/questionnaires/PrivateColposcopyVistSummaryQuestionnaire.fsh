...
* item[=].item[=].item[=].text = "Assessment for the reason for referral"
* item[=].item[=].item[=].answerOption[0].valueCoding = #other1 "Any cytological evidence or suspicion of invasion"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other2 "Any cytological glandular abnormality"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other3 "HPV 16/18 with or without cytology"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other4 "HPV other where the participant is immune compromised"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other5 "HPV other with LSIL on two occasions if over 50 and 3 occasions if under 50"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other6 "Low-grade clinical assessment"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other66 "HPV other where the participant is immune compromised"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other7 "HPV other with LSIL on two occasions if over 50 and 3 occasions if under 50"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other8 "Low-grade clinical assessment"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other9 "High-grade clinical assessment"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other0 "Suspicion of an invasive cancer clinical assessmentt"
* item[=].item[=].item[=].answerOption[+].valueCoding = #other33 "Other"
