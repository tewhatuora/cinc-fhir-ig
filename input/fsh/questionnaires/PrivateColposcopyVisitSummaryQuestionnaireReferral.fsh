...
* item[=].item[+].linkId = "3"
* item[=].item[=].text = "REFERRAL INFORMATION"
* item[=].item[=].type = #group
* item[=].item[=].prefix = "3."
...
* item[=].item[=].item[+].linkId = "3.4"
* item[=].item[=].item[=].prefix = "3.4."
* item[=].item[=].item[=].type = #string
* item[=].item[=].item[=].text = "Referred by health facility name"

* item[=].item[=].item[+].linkId = "3.5"
* item[=].item[=].item[=].prefix = "3.5."
* item[=].item[=].item[=].type = #date
* item[=].item[=].item[=].text = "Referral received date"

* item[=].item[=].item[+].linkId = "3.6"
* item[=].item[=].item[=].prefix = "3.6."
* item[=].item[=].item[=].type = #date
* item[=].item[=].item[=].text = "Referral accepted date"

* item[=].item[=].item[+].linkId = "3.7"
* item[=].item[=].item[=].prefix = "3.7."
* item[=].item[=].item[=].type = #date
* item[=].item[=].item[=].text = "Appointment date"

* item[=].item[=].item[+].linkId = "3.8"
* item[=].item[=].item[=].prefix = "3.8"
* item[=].item[=].item[=].type = #boolean
* item[=].item[=].item[=].required = true
* item[=].item[=].item[=].text = "First colposcopy visit?"

* item[=].item[=].item[+].linkId = "3.9"
* item[=].item[=].item[=].prefix = "3.9"
* item[=].item[=].item[=].enableWhen.question = "3.8"
...
* item[=].item[=].item[+].linkId = "3.10"
* item[=].item[=].item[=].prefix = "3.10."
* item[=].item[=].item[=].text = "Follow-up colposcopy visit"
* item[=].item[=].item[=].enableWhen.question = "3.9"
* item[=].item[=].item[=].enableWhen.operator = #=
...
* item[=].item[+].linkId = "4"
* item[=].item[=].text = "REASON FOR REFERRAL"
* item[=].item[=].type = #group
* item[=].item[=].prefix = "4."

* item[=].item[=].item[0].linkId = "4.1"
* item[=].item[=].item[=].text = "Assessment for the reason for referral"
* item[=].item[=].item[=].type = #display

* item[=].item[=].item[+].linkId  = "4.2"
* item[=].item[=].item[=].type = #choice
...
* item[=].item[=].item[=].answerOption[+].valueCoding = #r011 "Suspicion of an invasive cancer clinical assessment"
* item[=].item[=].item[=].answerOption[+].valueCoding = #r012 "Other"

* item[=].item[=].item[+].linkId = "4.3"
* item[=].item[=].item[=].type = #string
