...
* item[=].item[=].answer.valueCoding = #"Only flu vaccine" "Only flu vaccine"
...
* item[=].item[=].answer.valueCoding = #Yes "Yes"
...
* item[=].item[=].item[=].answer.valueCoding = #"Myself" "Myself"
* item[=].item[=].item[=].text = "Who received the vaccine?"
* item[=].item[=].item[+].linkId = "p02-q03.2-WhereReceived"
* item[=].item[=].item[=].answer.valueCoding = #"Community vaccination centre" "Community vaccination centre"
...
* item[=].item.answer.valueCoding = #"None of the above" "None of the above"
...
* item[=].item[=].answer.valueCoding = #"Less than 1 day" "Less than 1 day"
...
* item[=].item[=].answer[0].valueCoding = #"Phone advice from a helpline e.g., Healthline" "Phone advice from a helpline (e.g.,  Healthline)"
* item[=].item[=].answer[+].valueCoding = #"Whānau Ora navigator" "Whānau Ora navigator"
...
* item[=].item[=].answer.valueCoding = #"Average" "Average"
