...
* item[=].item.answer.valueCoding = #"Other" "Other"
...
* item[=].item[=].answer.valueCoding = #"Yes, You/they have been diagnosed with a medical condition attributed to vaccination" "Yes, You/they have been diagnosed with a medical condition attributed to vaccination"
