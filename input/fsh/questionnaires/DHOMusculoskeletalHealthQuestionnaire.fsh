...
* item.item[=].item.answerOption[0].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 4
* item.item[=].item.answerOption[=].valueCoding = $general-scale#4 "4 -- Not at all"
...
* item.item[=].item.answerOption[=].valueCoding = $general-scale#3 "3 -- Slightly"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 2
* item.item[=].item.answerOption[=].valueCoding = $general-scale#2 "2 -- Moderately"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 1
* item.item[=].item.answerOption[=].valueCoding = $general-scale#1 "1 -- Fairly severe"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Very severe"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 1
* item.item[=].item.answerOption[=].valueCoding = $general-scale#1 "1 -- Severely"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Not able to walk"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Unable to was or dress myself"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 1
* item.item[=].item.answerOption[=].valueCoding = $general-scale#1 "1 -- Very much"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Unable to do physicial activities"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Extremely"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 3
* item.item[=].item.answerOption[=].valueCoding = $general-scale#3 "3 -- Rarely"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 2
* item.item[=].item.answerOption[=].valueCoding = $general-scale#2 "2 -- Sometimes"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 1
* item.item[=].item.answerOption[=].valueCoding = $general-scale#1 "1 -- Frequently"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- All the time"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Every night"
...
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 3
* item.item[=].item.answerOption[=].valueCoding = $general-scale#3 "3 -- Slight"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 2
* item.item[=].item.answerOption[=].valueCoding = $general-scale#2 "2 -- Moderate"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 1
* item.item[=].item.answerOption[=].valueCoding = $general-scale#1 "1 -- Severe"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Extreme"
...
* item.item[=].item.answerOption[0].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 4
* item.item[=].item.answerOption[=].valueCoding = $general-scale#4 "4 -- Completely"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 3
* item.item[=].item.answerOption[=].valueCoding = $general-scale#3 "3 -- Very well"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 2
* item.item[=].item.answerOption[=].valueCoding = $general-scale#2 "2 -- Moderately"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 1
* item.item[=].item.answerOption[=].valueCoding = $general-scale#1 "1 -- Slightly"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 0
* item.item[=].item.answerOption[=].valueCoding = $general-scale#0 "0 -- Not at all"
...
* item.item[=].item.answerOption[0].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 4
* item.item[=].item.answerOption[=].valueCoding = $general-scale#4 "4 -- Extremely"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 3
* item.item[=].item.answerOption[=].valueCoding = $general-scale#3 "3 -- Very"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
* item.item[=].item.answerOption[=].extension.valueDecimal = 2
* item.item[=].item.answerOption[=].valueCoding = $general-scale#2 "2 -- Moderately"
* item.item[=].item.answerOption[+].extension.url = "http://hl7.org/fhir/StructureDefinition/ordinalValue"
...
* item.item[=].extension.valueExpression.expression = "%resource.repeat(item).where(linkId = 'painStiffnessPinsAndNeedlesDay' or linkId = 'painStiffnessPinsAndNeedlesNight' or linkId = 'walking' or linkId = 'washingDressing' or linkId = 'physicalActivityLevels' or linkId = 'workDailyRoutine' or linkId = 'socialActivitiesAndHobbies' or linkId = 'impactOnOthersAroundMe' or linkId = 'sleep' or linkId = 'fatigueOrLowEnergy' or linkId = 'emotionalWellBeing' or linkId = 'understandingOfYourConditionAndCurrentTreatment' or linkId = 'confidenceInBeingAbleToManageYourSymptoms' or linkId = 'overallImpact').answer.value.ordinal().sum()"
